    ...
    <div class="app-shell">
      <header class="topbar">
        <div class="topbar-row topbar-row--top">
          <a class="brand" href="${pageContext.request.contextPath}/index.jsp" aria-label="校屿树洞首页">
      ...
      <main class="workspace">
        <section class="compose-panel" aria-labelledby="composeTitle">
          ...
          <form class="composer" id="postForm">
            ...
            <div class="form-grid">
              ...
              <label>
                <span>署名</span>
                <input id="postAlias" maxlength="12" placeholder="匿名同学" />
              </label>
            </div>
        ...
        <aside class="insight-panel" aria-label="树洞侧栏">
          <section class="mini-section ai-entry-card ai-entry-card--primary">
            ...
            <h3>把难说的话先说给 AI 听</h3>
            <p class="soft-text">可以帮你整理心情、润色树洞，也可以先安静地听你说一会儿。</p>
